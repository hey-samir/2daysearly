      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
        <AnimatedSection className="text-center lg:text-left" delay={0.2}>
          ...
          <div className="mt-8 flex flex-wrap justify-center lg:justify-start gap-4">
            ...
            <a href="https://tally.so/r/nP1v8e" target="_blank" rel="noopener noreferrer" className="bg-gray-100 text-gray-900 dark:bg-gray-800 dark:text-gray-100 px-6 py-3 rounded-md font-medium hover:bg-gray-200 dark:hover:bg-gray-700 w-full sm:w-auto text-center">
              JOIN*
            </a>
            <a href="https://interspace.samir.xyz/p/101-everything-you-wanted-to-know" target="_blank" rel="noopener noreferrer" className="bg-gray-100 text-gray-900 dark:bg-gray-800 dark:text-gray-100 px-6 py-3 rounded-md font-medium hover:bg-gray-200 dark:hover:bg-gray-700 w-full sm:w-auto text-center">
              LEARN
            </a>
          </div>
