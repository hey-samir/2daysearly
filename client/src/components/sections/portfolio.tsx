        ...
        >
          {[
            ...
            <a 
              ...
              className="group relative bg-white dark:bg-gray-800 rounded-lg shadow-sm hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1 h-40 inline-flex items-center justify-center"
              role="listitem"
            >
              ...
              <Image 
                ...
                className="w-auto h-auto max-h-16 max-w-[90%] object-contain m-0"
